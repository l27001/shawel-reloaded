...
func.prototype.elemPrev = function(num) {
	num = num || 1;
...
func.prototype.elemNext = function(num) {
	num = num || 1;
...
func.prototype.dotOn = function(num) {
	this.indicatorDotsAll[num].style.cssText = 'background-color:#BBB; cursor:pointer;'
};

func.prototype.dotOff = function(num) {
	this.indicatorDotsAll[num].style.cssText = 'background-color:#556; cursor:default;'
};

func.initialize = function(that) {
